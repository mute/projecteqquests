...
sub EVENT_ITEM {
	if ($faction == 1) {
		if (plugin::check_handin(\%itemcount, 69339 => 1, 69338 => 1, 69337 => 1)) {
			...
			if (plugin::HasClass("Warrior")) { quest::summonitem(69383);
			} elsif (plugin::HasClass("Paladin")) { quest::summonitem(69383);
			} elsif (plugin::HasClass("Ranger")) { quest::summonitem(69383);
			} elsif (plugin::HasClass("Shadowknight")) { quest::summonitem(69383);
			} elsif (plugin::HasClass("Monk")) { quest::summonitem(69383);
			} elsif (plugin::HasClass("Bard")) { quest::summonitem(69383);
			} elsif (plugin::HasClass("Rogue")) { quest::summonitem(69383);
			} elsif (plugin::HasClass("Beastlord")) { quest::summonitem(69383);
			} elsif (plugin::HasClass("Berserker")) { quest::summonitem(69383);
