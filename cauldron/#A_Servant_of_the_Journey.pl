...
my $flavor_text = "Within the sunken corridors of Kedge Keep lurks the last of the once-mighty Kedge, Phinigel Autropos."; #TODO

my $zone_name       = 'kedge';
my $prog_stage      = 'RoK';
my $prog_substage   = 'Phinigel Autropos';
my $reward          = 5;
my @task_id         = (5,6);
