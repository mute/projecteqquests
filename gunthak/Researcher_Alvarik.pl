...
sub EVENT_SAY {
  ...
  if($text=~/enchanter/i) {
    if ((plugin::HasClass("Enchanter")) && ($client->GetSkill(58) > 100)) {
  ...
  if($text=~/wizard/i) {
    if ((plugin::HasClass("Wizard")) && ($client->GetSkill(58) > 100)) {
  ...
  if($text=~/magician/i) {
    if ((plugin::HasClass("Magician")) && ($client->GetSkill(58) > 100)) {
  ...
  if($text=~/necromancer/i) {
    if ((plugin::HasClass("Necromancer")) && ($client->GetSkill(58) > 100)) {
