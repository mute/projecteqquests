...
#	  }
  #epic 1.0
	  ...
	  if($text=~/hail/i && plugin::HasClass("Berserker") && plugin::check_hasitem($client, 68299) && $qglobals{"berserk_epic"} == undef) {
	  ...
	  if($text=~/hail/i && plugin::HasClass("Berserker") && $ulevel > 45 && $dragon == undef && $imp == undef  && !plugin::check_hasitem($client, 68299)) {
	  ...
	  if($text=~/master the fires/i && plugin::HasClass("Berserker") && $ulevel > 45 && $dragon == undef && $imp == undef) {
	  ...
	  if($text=~/great stride/i && plugin::HasClass("Berserker") && $ulevel > 45) { #&& $dragon == undef && $imp == undef #removed this so can be repeated
	  ...
	  if($text=~/hail/i && $ulevel < 46 && plugin::HasClass("Berserker")) {
	  ...
	  if($text=~/ready/i && $ulevel > 45 && plugin::HasClass("Berserker") && $imp == 1) {
	  ...
	  if($text=~/never control the rage/i && $ulevel > 45 && plugin::HasClass("Berserker") && $imp == 1) {
	  ...
	  if($text=~/face one/i && $ulevel > 45 && plugin::HasClass("Berserker") && $imp == 1) {
	  ...
	  if($text=~/enraged essence/i && $ulevel > 45 && plugin::HasClass("Berserker") && $imp == 1) {
