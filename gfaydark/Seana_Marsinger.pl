...
sub EVENT_SAY {
 ...
 if(($text=~/interested/i) && ((plugin::HasClass("Wizard")) || (plugin::HasClass("Magician")) || (plugin::HasClass("Necromancer")) || (plugin::HasClass("Enchanter")) || (plugin::HasClass("Ranger")) || (plugin::HasClass("Paladin")) || (plugin::HasClass("Shadowknight")) || (plugin::HasClass("Beastlord")) || (plugin::HasClass("Bard")))) {
   ...
   if(($text=~/interested/i) && ((plugin::HasClass("Cleric")) || (plugin::HasClass("Shaman")) || (plugin::HasClass("Druid")))) {
   ...
   if(($text=~/interested/i) && ((plugin::HasClass("Warrior")) || (plugin::HasClass("Rogue")) || (plugin::HasClass("Monk")))) {
 ...
 if(($text=~/work/i) && ((plugin::HasClass("Wizard")) || (plugin::HasClass("Magician")) || (plugin::HasClass("Necromancer")) || (plugin::HasClass("Enchanter")) || (plugin::HasClass("Ranger")) || (plugin::HasClass("Paladin")) || (plugin::HasClass("Shadowknight")) || (plugin::HasClass("Beastlord")) || (plugin::HasClass("Bard")))) {
   quest::say("Please speak to my brother, Stefan, for further information. He will be your primary contact for any tasks you perform for us in Innoruuk's realm. The League of Antonican Bards and I commend you for your efforts.");
 }
  if(($text=~/work/i) && ((plugin::HasClass("Warrior")) || (plugin::HasClass("Rogue")) || (plugin::HasClass("Monk")))) {
   ...
   if(($text=~/work/i) && ((plugin::HasClass("Cleric")) || (plugin::HasClass("Shaman")) || (plugin::HasClass("Druid")))) {
 ...
 if(($text=~/final task/i) && ((plugin::HasClass("Wizard")) || (plugin::HasClass("Magician")) || (plugin::HasClass("Necromancer")) || (plugin::HasClass("Enchanter")) || (plugin::HasClass("Ranger")) || (plugin::HasClass("Paladin")) || (plugin::HasClass("Shadowknight")) || (plugin::HasClass("Beastlord")) || (plugin::HasClass("Bard")))) {
   quest::say("Please speak to my brother, Stefan, for further information. He will be your primary contact for any tasks you perform for us in Innoruuk's realm. The League of Antonican Bards and I commend you for your efforts.");
 }
   if(($text=~/final task/i) && ((plugin::HasClass("Warrior")) || (plugin::HasClass("Rogue")) || (plugin::HasClass("Monk")))) {
   ...
   if(($text=~/final task/i) && ((plugin::HasClass("Cleric")) || (plugin::HasClass("Shaman")) || (plugin::HasClass("Druid")))) {
