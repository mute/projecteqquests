    ...
    # Condition 4: This character has interacted with Zeb before, and the most recent time was this character.
        ...
        if (plugin::GetClassesCount($client) >= 3) {
            ...
            my $popup_message = "$text_red Please Read Completely $text_color_end $text_break $text_break $text_break" .
                                ...
                                " and even more 'hidden' features like AC caps and melee damage bonuses. $text_break $text_break" .
                                ...
                                "immediately disconnected so that certain changes can be made to your character in order for Bard abilities to work correctly. " . #TODO - update this with however bards work out
                                ...
                                "Please report any such issues on our Discord so that they can be corrected.";
