...
function event_trade(e)
	...
	if (e.other:GetFaction(e.self) <= 1 or e.other:GetGM() and (e.other:HasClass("Monk") or e.other:HasClass("Beastlord") or e.other:HasClass("Druid") or e.other:GetGM())) then -- require ally and leather
