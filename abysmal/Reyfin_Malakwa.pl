...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 59907 => 1)) { # Chaos Rune
    ...
    if (plugin::HasClass("Warrior")){quest::summonitem(59909);} # Chaos Cry
    elsif (plugin::HasClass("Berserker")){quest::summonitem(59919);} # Cry of Chaos
    elsif (plugin::HasClass("Ranger")){quest::summonitem(59855);} # Ancient: Burning Chaos
    elsif (plugin::HasClass("Bard")){quest::summonitem(59846);} # Ancient: Chaos Chant 
    elsif (plugin::HasClass("Rogue")){quest::summonitem(59911);} # Chaos Strike
    elsif (plugin::HasClass("Paladin")){quest::summonitem(59852);} # Ancient: Force of Chaos
    elsif (plugin::HasClass("Shadowknight")){quest::summonitem(59857);} # Ancient: Bite of Chaos
    elsif (plugin::HasClass("Monk")){quest::summonitem(59913);} # Phantom Chaos
    elsif (plugin::HasClass("Beastlord")){quest::summonitem(59847);} # Ancient: Frozen Chaos
    elsif (plugin::HasClass("Cleric")){quest::summonitem(59848);} # Ancient: Chaos Censure
    elsif (plugin::HasClass("Druid")){quest::summonitem(59849);} # Ancient: Chaos Frost
    elsif (plugin::HasClass("Shaman")){quest::summonitem(59854);} # Ancient: Chaotic Pain
    elsif (plugin::HasClass("Enchanter")){quest::summonitem(59850);} # Ancient: Chaos Madness
    elsif (plugin::HasClass("Magician")){quest::summonitem(59851);} # Ancient: Chaos Vortex
    elsif (plugin::HasClass("Necromancer")){quest::summonitem(59853);} # Ancient: Seduction of Chaos
    elsif (plugin::HasClass("Wizard")){quest::summonitem(59856);} # Ancient: Strike of Chaos
    quest::exp(10000);
  }
    ...
    if (plugin::HasClass("Warrior")){quest::summonitem(59908);} # Bellow of the Mastruq
    elsif (plugin::HasClass("Berserker")){quest::summonitem(59918);} # Battle Cry of the Mastruq
    elsif (plugin::HasClass("Ranger")){quest::summonitem(59835);} # Sylvan Burn
    elsif (plugin::HasClass("Bard")){quest::summonitem(59811);} # Echo of the Trusik
    elsif (plugin::HasClass("Rogue")){quest::summonitem(59910);} # Kyv Strike
    elsif (plugin::HasClass("Paladin")){quest::summonitem(59831);} # Wave of Trushar
    elsif (plugin::HasClass("Shadowknight")){quest::summonitem(59841);} # Black Shroud
    elsif (plugin::HasClass("Monk")){quest::summonitem(59912);} # Phantom Shadow
    elsif (plugin::HasClass("Beastlord")){quest::summonitem(59814);} # Trushar's Mending
    elsif (plugin::HasClass("Cleric")){quest::summonitem(59821);} # Holy Elixir
    elsif (plugin::HasClass("Druid")){quest::summonitem(59823);} # Sylvan Fire
    elsif (plugin::HasClass("Shaman")){quest::summonitem(59837);} # Breath of Trushar
    elsif (plugin::HasClass("Enchanter")){quest::summonitem(59817);} # Bliss of the Nihil
    elsif (plugin::HasClass("Magician")){quest::summonitem(59825);} # Elemental Siphon
    elsif (plugin::HasClass("Necromancer")){quest::summonitem(59828);} # Night Stalker
    elsif (plugin::HasClass("Wizard")){quest::summonitem(59844);} # White Fire
    quest::exp(10000);
  }
  elsif (plugin::check_handin(\%itemcount, 59975 => 1)) { # Taelosian Geomancy Stone Eril
    if (plugin::HasClass("Ranger")){quest::summonitem(59836);} # Sylvan Call
    elsif (plugin::HasClass("Bard")){quest::summonitem(59812);} # Dark Echo
    elsif (plugin::HasClass("Paladin")){quest::summonitem(59833);} # Holy Order
    elsif (plugin::HasClass("Shadowknight")){quest::summonitem(59842);} # Miasmic Spear
    elsif (plugin::HasClass("Beastlord")){quest::summonitem(59815);} # Trushar's Frost
    elsif (plugin::HasClass("Cleric")){quest::summonitem(59820);} # Order
    elsif (plugin::HasClass("Druid")){quest::summonitem(59824);} # Sylvan Embers
    elsif (plugin::HasClass("Shaman")){quest::summonitem(59839);} # Daluda's Mending
    elsif (plugin::HasClass("Enchanter")){quest::summonitem(59818);} # Madness of Ikkibi
    elsif (plugin::HasClass("Magician")){quest::summonitem(59827);} # Monster Summoning IV
    elsif (plugin::HasClass("Necromancer")){quest::summonitem(59830);} # Night's Beckon
    elsif (plugin::HasClass("Wizard")){quest::summonitem(59845);} # Telaka
    quest::exp(10000);
  }
  elsif (plugin::check_handin(\%itemcount, 59974 => 1)) { # Taelosian Geomancy Stone Yiktu
    if (plugin::HasClass("Ranger")){quest::summonitem(59834);} # Sylvan Light
    elsif (plugin::HasClass("Bard")){quest::summonitem(59810);} # War March of the Mastruq
    elsif (plugin::HasClass("Paladin")){quest::summonitem(59832);} # Light of Order
    elsif (plugin::HasClass("Shadowknight")){quest::summonitem(59840);} # Mental Horror
    elsif (plugin::HasClass("Beastlord")){quest::summonitem(59813);} # Turepta Blood
    elsif (plugin::HasClass("Cleric")){quest::summonitem(59819);} # Holy Light
    elsif (plugin::HasClass("Druid")){quest::summonitem(59822);} # Sylvan Infusion
    elsif (plugin::HasClass("Shaman")){quest::summonitem(59838);} # Balance of the Nihil
    elsif (plugin::HasClass("Magician")){quest::summonitem(59826);} # Rock of Taelosia
    elsif (plugin::HasClass("Enchanter")){quest::summonitem(59816);} # Dreary Deeds
    elsif (plugin::HasClass("Necromancer")){quest::summonitem(59829);} # Night Fire
    elsif (plugin::HasClass("Wizard")){quest::summonitem(59843);} # Black Ice
    quest::exp(10000);
  }
